...
'''
    ...
    Program Description:
        This program contains functions for data sampling, loss functions, metrics, 
...
def select_random_patches(data, label, mask, opt):
  """
...
def select_roi_patches(data, label, mask, opt):
  """
