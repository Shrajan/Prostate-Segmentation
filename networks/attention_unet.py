...
'''
    ...
    File Name   : attention_unet.py
    Code Author : Shrajan Bhandary
    Created on  : 14 March 2021
    Program Description:
        This program was forked from https://github.com/ozan-oktay/Attention-Gated-Networks/. It is
        based on the paper "Attention U-Net: Learning Where to Look for the Pancreas." Article 
        available at https://arxiv.org/abs/1804.03999.
